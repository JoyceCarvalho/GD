        ...
        <!--<div class="breadcrumb-holder container-fluid">
            <ul class="breadcrumb">
              ...
              <li class="breadcrumb-item active">Cadastrar Ausência </li>
            </ul>
        </div>-->
        <!-- Forms Section-->
        <section class="forms"> 
                            ...
                            <div class="card-body">
                                <form method="post" action="<?=base_url('cad_ausencia');?>" class="form-horizontal">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="datetime-local" name="dia_inicio" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="datetime-local" name="dia_fim" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea name="motivo" id="editor1" cols="30" rows="10"></textarea>
                                        </div>
                                    </div>
