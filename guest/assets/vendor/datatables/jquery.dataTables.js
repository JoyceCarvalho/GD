...
(function( $, window, document, undefined ) {
	...
	function _fnPageChange ( settings, action, redraw )
	{
		...
		{
			_fnLog( settings, 0, "Ação de paginação desconhecida: "+action, 5 );
		}
	...
	function _fnLog( settings, level, msg, tn )
	{
		...
		if ( tn ) {
			msg += '. Para mais informações sobre este erro, por favor veja '+
	...
	DataTable.defaults = {
		 ...
		 *           json[i][0] = '<a href="/message/'+json[i][0]+'>Ver mensagem</a>';
		 *         }
		 *         return json;
		 *       }
		 *     }
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sLengthMenu": "Mostra _MENU_ entradas",
