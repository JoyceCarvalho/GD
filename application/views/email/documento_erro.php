                    ...
                    <section class="invoice">
                        ...
                        <div class="row">
                            <div class="col-12 table-responsive">
                                <p>O documento <strong><?=$documento;?></strong> de protocolo <strong><?=$protocolo;?></strong> retornou com erro para a etapa de responsabilidade de <?=$usuario;?>!</p>
                                <p>
                                    Erro <strong><?=$erro?></strong> de natureza <strong><?=$tipo_erro?></strong><br/>
                                    Descrição: <?=$descricao;?>
                                </p>
                                <br/>
