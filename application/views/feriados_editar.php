                    ...
                    <div class="card-body">
                        <form method="post" action="<?=base_url('edit_feriado');?>" class="form-horizontal">
                            ...
                            foreach ($dados_feriado as $feriado) {
                                $dia = verifica_tipo_data($feriado->dia);
                                if (strlen($dia) == 10) {
                                    $sel_1 = "";
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="feriado_tipo" id="feriado_tipo" class="form-control">
                                            <option <?=$sel_1?> value="1">Feriados Fixos</option>
                                            <option <?=$sel_2?> value="2">Feriados Móveis</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div id="tipo">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <?php if(strlen($dia) == 10): ?>
                                                <input type="date" class="form-control" id="dia_mes" name="dia" value="<?=$feriado->dia;?>">
                                            <?php else: ?>
                                                <input type="text" class="form-control" name="dia" value="<?=$dia;?>">
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                </div>
