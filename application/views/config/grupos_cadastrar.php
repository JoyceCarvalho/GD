        ...
        <!--<div class="breadcrumb-holder container-fluid">
            <ul class="breadcrumb">
              <li class="breadcrumb-item"><a href="<?=base_url('grupodocumentos');?>">Listar Grupos</a></li>
              <li class="breadcrumb-item active">Cadastrar Grupos de Documentos </li>
            </ul>
        </div>-->
        <!-- Forms Section-->
        <section class="forms"> 
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form method="post" action="<?=base_url('cad_grupo');?>" class="form-horizontal">
