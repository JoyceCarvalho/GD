            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-header d-flex align-items-center">
                        <h3 class="h4">Documentos fora do prazo</h3>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">                       
                            <table class="table table-striped table-hover" id="datatable">
                                ...
                                <tbody>
                                    <?php
                                    foreach ($doc_prazo as $documentos) {
                                        ?>
                                        <tr>
                                            <td><?=$documentos->protocolo;?></td>
                                            <td>
                                                <?=$documentos->titulo_documento;?><br/>
                                                <strong><?=$documentos->titulo_grupo;?></strong>
                                            </td>
                                            <td><?=$documentos->data_criacao;?></td>
                                            <td>
                                                <?=$documentos->etapa_atual;?><br/>
                                            </td>
