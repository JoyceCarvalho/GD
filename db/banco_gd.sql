...
--
-- Host: localhost
-- Generation Time: 25-Jun-2018 às 19:19
...
(1, 'SGT - Gestão e Tecnologia', 'sgtgestaoetecnologia', NULL, 'Proporcionar ferramentas que facilitem a gestão das práticas e excelência organizacional.', NULL, 'Respeito ao usuário.\r\nRapidez nas soluções.\r\nInovação permantente.', 1);
...
ALTER TABLE `tbobservacoes`
  ...
  ADD KEY `fk_idprotocolo` (`fk_idprotocolo`);
...
--
ALTER TABLE `tbobservacoes`
  ADD CONSTRAINT `tbobservacoes_ibfk_1` FOREIGN KEY (`fk_idusuario`) REFERENCES `tbusuario` (`id`),
  ADD CONSTRAINT `tbobservacoes_ibfk_2` FOREIGN KEY (`fk_idetapa`) REFERENCES `tbetapa` (`id`),
  ADD CONSTRAINT `tbobservacoes_ibfk_3` FOREIGN KEY (`fk_idprotocolo`) REFERENCES `tbdocumentos_cad` (`id`);
